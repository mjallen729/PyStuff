...
The eval function is definitely NOT O(1), because I wasn't sure as to how that would be possible, especially since looking through the board would require loops anyway. Also, I reused my basic minimax algorithm and adjusted it for each scenario numerous times. I also used some interior helper functions that I created so I could keep everything mostly recursive and pass parameters correctly.
